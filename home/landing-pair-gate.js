...
export function installLandingPairGate(userOptions = {}) {
  ...
  function normalizeCopy(override, nouns) {
    const base = {
      ...
      closeAria: 'Close',
      sublineCamera: `Before you use Camera mode, let’s pair your ${nouns.plural}.`,
      sublineViewer: `Before you use Viewer mode, let’s pair your ${nouns.plural}.`,
      bullet1: 'Generate a one-time secret',
      bullet2: `Install it on the other ${nouns.singular} via QR/Share`,
